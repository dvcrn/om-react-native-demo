...
{
  [context evaluateScript:[NSString stringWithFormat:@"goog.require('%@');", [self munge:@"demo.core"]]];
}
...
- (void)contentDidAppear
{
  ...
  JSValue* initFn = [self getValue:@"init" inNamespace:@"demo.core" fromContext:context];
